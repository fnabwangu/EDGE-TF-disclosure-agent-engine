...
* **`Rule 6c-11 Real-Time NAV Synthetic Valuation`**: Aggregates real-time equity bid-ask midpoints, intraday cash drag, and accrued expenses per creation unit basket.
* **`Derivatives Overlay Intra-Day Fair Valuation`**: Evaluates intraday fair value for written covered calls and short LEAP puts using standard Black-Scholes approximations with real-time underlying updates.
